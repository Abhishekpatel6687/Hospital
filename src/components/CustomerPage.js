...
const CustomerPage = () => {
  return (
    <div className="min-h-full max-w-full bg-backgroundHome">
      <h1 className="xs:text-center sm:ml-20 pb-14 xs:text-2xl text-4xl font-semibold text-h1Color">
        ...
        <div className="flex justify-center items-center lg:h-80 lg:w-1/2 ">
          <div className="lg:flex flex justify-center items-center xs:mb-20 sm:mb-20 lg:mb-0  xs:w-10/12 xs:h-10/12 h-64 w-4/6  lg:h-72 lg:w-10/12 lg:ml-14 relative rounded-2xl drop-shadow-2xl bg-white ">
            ...
            <div className="  lg:h-52 lg:w-9/12 h-48 w-4/5 xs:h-44 xs:w-10/12 ">
              <p className="sm:leading-7 xs:leading-6 md:leading-8 sm:text-xl text-pColor">
              ...
              <div className="flex mt-6">
                <img
                  ...
                  alt="img2"
                />
                <div className="flex-col ml-6 text-pColor">
                  <h1 className="text-2xl xs:text-xl font-semibold">
                    Jacqueline Asong
                  </h1>
